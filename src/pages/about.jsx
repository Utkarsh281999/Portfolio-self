        ...
        <div className="about-left">
          ...
          <div className="para">
            <p>
              ...
              with over 3 years of professional experience developing
            ...
            <p>
              ...
              <strong> full-stack development</strong>, DevOps automation, and
              cloud platforms including AWS. I specialize in architecting scalable
              systems and implementing CI/CD pipelines that optimize development
              velocity and product reliability.
            </p>

            <p>
              I am committed to staying at the forefront of technological
              innovation, consistently applying emerging technologies to solve
              complex business challenges across web applications, cloud
              infrastructure, and system architecture domains.
            </p>
          </div>
        </div>
